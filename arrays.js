...
//  So the fist player will recieve the last card:
...
//  Loops are frequently used with arrays.  Let's say I want to print out the while queue
//      from before. THis will be after we added Mrs. Breetz. A useful thin to know is 
...
//  Let's say I want to get all of the even numbers less than 100, and I already have a
//      list that containts the numbers 0-99:
...
//  for...of loops allows us to easily loop arrays 
//  I want a new array that is only multiples of 6. So my even number must also be 
//      divisible by 3.
...
//  You can also have multidimensional arrays.  That is to say, an array that contains more arrays

let studentInfo = [["Grant", "27henng@badinhs.org", 1],["Nick", "26manginon@badinhs.org", 2],["Raynah", "26graur@badinhs.org", 3]]
console.log(studentInfo);

//  This gives the first complete array:
